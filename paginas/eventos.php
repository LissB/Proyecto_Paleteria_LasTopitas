      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbars-rs-food">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="controlMerma.php">Control Merma</a></li>
...
<div class="container-fluid ">
 <form method="post">
    ...
    <div class="form-group obtds">
      <label class="control-label tamla" for="nombreEvento">Nombre de Evento :</label>
      <div class="col bg-info">
        <input type="text" class="form-control text-uppercase" name="nombreEvento" placeholder="Cumpleaños" maxlength="10"
        value="<?php if(isset($_GET['editar'])) echo $getROW['nombreEvento'];  ?>" />
      </div>
    </div>
    <div class="form-group obtds">
      <label class="control-label tamla" for="nombreCliente">Nombre de Cliente :</label>
      <div class="col bg-info">
        <input type="text" class="form-control text-uppercase" name="nombreCliente" placeholder="Maria Perez" maxlength="10"
        value="<?php if(isset($_GET['editar'])) echo $getROW['nombreCliente'];  ?>" />
      </div>
    </div>
    <div class="form-group obtds">
      <label class="control-label tamla" for="telefonoCliente">Teléfono de Cliente:</label>
      <div class="col bg-info">
        <input type="text" class="form-control text-uppercase" name="telefonoCliente" placeholder="9851000000" maxlength="10"
        value="<?php if(isset($_GET['editar'])) echo $getROW['telefonoCliente'];  ?>" />
      </div>
    </div>
    <div class="form-group obtds">
      <label class="control-label tamla" for="correoCliente">Correo de Cliente:</label>
      <div class="col bg-info">
        <input type="text" class="form-control text-uppercase" name="correoCliente" placeholder="mariaperez@gmail.com" maxlength="10"
        value="<?php if(isset($_GET['editar'])) echo $getROW['correoCliente'];  ?>" />
      </div>
    </div>
    <div class="form-group obtds">
      <label class="control-label tamla" for="direccionEvento">Dirección de Evento:</label>
      <div class="col bg-info">
        <input type="text" class="form-control text-uppercase" name="direccionEvento" placeholder="C. 5 x 4 y 3, Valladolid" maxlength="10"
        value="<?php if(isset($_GET['editar'])) echo $getROW['direccionEvento'];  ?>" />
      </div>
    </div>
    <div class="form-group obtds">
      <label class="control-label tamla" for="fechaEvento">Fecha de Evento:</label>
      <div class="col bg-info">
        <input type="text" class="form-control text-uppercase" name="fechaEvento" placeholder="0000-00-00" maxlength="10"
        value="<?php if(isset($_GET['editar'])) echo $getROW['fechaEvento'];  ?>" />
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="col-12"><li class="active estMe btns"><a href="eventosD.php">AGREGAR O ELIMINAR EVENTOS</a></li></div>
    </div>
  </form>
<?php
...
?>
 <h3 class="textoTa text-center">Listado de ventas del Evento</h3>
